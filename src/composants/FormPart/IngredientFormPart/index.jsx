...
const IngredientFormPart = ({ selectedEntryColumns, setSelectedEntryColumns, handleSubmit, handleClose, isLoading }) => {
    ...
    const handleInputChange = (e) => {
        ...
        if (name === "quantity" || name ==='maxQuantity') {
            ...
            setSelectedEntryColumns(prevEntryColumns => ({
                ...prevEntryColumns,
                [name]: isNaN(quantity) ? prevEntryColumns[name] : quantity
            }));
        } else {
            setSelectedEntryColumns(prevEntryColumns => ({
                ...prevEntryColumns,
        ...
        <>
            ...
            <Modal show={true} onHide={handleClose} centered>
                <Modal.Header closeButton>
                    <Modal.Title className="modal-title">{selectedEntryColumns ? 'Édition ' : 'Ajout '}d'ingrédients</Modal.Title>
                </Modal.Header>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" controlId="quantity">
                            <Form.Label>Quantité<span className='text-primary ml-2'>*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3" controlId="maxQuantity">
                            <Form.Label>Quantité max<span className='text-primary ml-2'>*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3" controlId="unit">
                            <Form.Label>Unité<span className='text-primary ml-2'>*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3" controlId="unit">
                            <Form.Label>Catégorie<span className='text-primary ml-2'>*</span></Form.Label>
                        ...
                        <Form.Group className="mb-3" controlId="isAllergen">
                            <Form.Label>Allergène ?<span className='text-primary ml-2'>*</span></Form.Label>
